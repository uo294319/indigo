...
const rows = [
  ...
  { cap: 'IVA 21% s/ PEM',                                               imp: '771.361 €',   pct: 20 },
]
      ...
      <div style={{ display: 'flex', gap: 56, flex: 1, minHeight: 0, alignItems: 'flex-start' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 24, flexShrink: 0, width: 340 }}>
          ...
          <div>
            ...
            {[
              { label: 'Hardware logístico', pct: 72, color: '#00D2A0' },
              { label: 'Serv. profesionales', pct: 13, color: '#334155' },
              { label: 'Mantenimiento',       pct: 11, color: '#475569' },
              { label: 'IVA (21%)',           pct: 20, color: '#1E2939' },
            ].map(({ label, pct, color }) => (
        ...
        <div style={{ flex: 1 }}>
          <table style={{ borderCollapse: 'collapse', width: '100%', marginBottom: 24 }}>
            <tbody>
              ...
              <tr>
                <td style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: '0.9rem', color: 'white', padding: '12px 0 0 0', paddingRight: 16, fontWeight: 700 }}>TOTAL IVA INCLUIDO</td>
                <td style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: '1.05rem', color: '#00D2A0', padding: '12px 0 0 0', textAlign: 'right' }}>4.444.507 €</td>
              </tr>
            </tbody>
          </table>
